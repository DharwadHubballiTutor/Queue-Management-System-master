...
import smtplib
sender_email = "atharshaikh1@gmail.com"
password = "MLSnThjEJ1V8m0DH"
from email.mime.text import MIMEText
from email.mime.multipart import MIMEMultipart

#phone: input your twilio account's SID, token and phone number as a string below
from twilio.rest import Client
account_sid = 'AC7758e69bc0df317d9251263792278205'
auth_token = '92f40350e63553cf06dc256bc2627e32'
twilio_phone = '+919741237334'   #start with '+'
    ...
    if not counters:
        ...
        #checking if phone number if numeric and has a length of 10 digits
            ...
            try:
                ...
                message['Subject'] = "OTP for Queue Booking"  # Add a subject

# Create the body of the email
                body = "Dear {}, OTP to book your position in queue is {}. Do not share it with anyone.".format(name, otpNum)
                message.attach(MIMEText(body, 'plain'))
                try:
                    with smtplib.SMTP('smtp-relay.brevo.com', 587) as server:
                        server.starttls()  # Secure the connection
                        server.login(sender_email, password)  # Log in to the SMTP server
                        server.sendmail(sender_email, rec_email, message.as_string())  # Send the email
                ...
                return redirect('otp', phoneNumber, otpNum)
            except Exception as e:
...
def otp(request, phoneNumber,otp):
...
# Create the body of the email
            body = "Dear {}, your Token number is {}.".format(d.name, uid)
            message.attach(MIMEText(body, 'plain'))
            try:
                    with smtplib.SMTP('smtp-relay.brevo.com', 587) as server:
                        server.starttls()  # Secure the connection
        ...
        return render(request, 'otp.html', {'phoneNumber' : phoneNumber, 'otp' : otp})
